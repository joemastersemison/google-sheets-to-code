import type { Cell, ParsedFormula, Sheet } from "../types/index.js";
...
describe("DependencyAnalyzer", () => {
  ...
  describe("getCalculationOrder", () => {
    ...
    it("should handle complex dependency trees", () => {
      ...
      expect(order.indexOf("Sheet1!B1")).toBeLessThan(
        order.indexOf("Sheet1!C1")
      );
      expect(order.indexOf("Sheet1!B2")).toBeLessThan(
        order.indexOf("Sheet1!C1")
      );
    });
  });
