...
describe('FormulaLexer', () => {
  ...
  describe('operators', () => {
    it('should tokenize arithmetic operators', () => {
      const operators = ['+', '-', '*', '/', '^', '%'];
      const expectedTypes = ['Plus', 'Minus', 'Multiply', 'Divide', 'Power', 'Percent'];
    ...
    it('should tokenize comparison operators', () => {
      const operators = ['=', '<>', '<', '>', '<=', '>='];
      const expectedTypes = ['Equals', 'NotEquals', 'LessThan', 'GreaterThan', 'LessThanOrEqual', 'GreaterThanOrEqual'];
